...
if (empty ($name)) {
  ...
  */
  ...
  $speech = "/moveup ($nick): syntax is: /moveup \"forum name\".";
  ...
  */
  ...
  if ($fid > 0) {
    ...
    /*
      ...
      retrieve forums' list ("forums/index"), move forum #ID up one place by exchanging
      its place with that of the entry that preceeds it (if no entry follows, output an error)
    */
      ...
      if (intval (valueOf ($forums[$n], "id")) == $fid) {
        ...
        if ($n > 0) {
          ...
          */
          ...
          $speech = "/moveup ($nick): forum &quot;$name&quot; is already at top of list.";
    ...
    if ($changed) {
      ...
      */
      ...
      $speech = "/moveup ($nick): forum &quot;$name&quot; moved one place up in list.";
    ...
    $speech = "/moveup ($nick): forum &quot;$name&quot; doesn't exist.";
