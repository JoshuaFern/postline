...
$proceed = (defined ('going')) ? true : die ('[ postline right-side frame cookie URI update ]');
 ...
 *      page to be loaded in the right-side frame: it's to be included by Postline scripts which
 *      need to change the right-side frame's record in the cookie to reflect the caller's URI
 *
 */
...
$frame_cookie_hold = strBefore ($frame_cookie_hold, '&') . '&r=' . $given_request_uri;
